...
public class NumberDialogActivity extends Activity implements TextWatcher,
    ...
    private void init() {
        ...
        String str = SharedPreferencesUtils.getString("history_number");
    ...
    public void onClick(View v) {
        if (v == btnCancel) {// 取得“取消”按钮监听
            ...
            String string = SharedPreferencesUtils.getString("history_number");
            if (!string.contains(strPhoneNumber)) {
                SharedPreferencesUtils.put("history_number", strPhoneNumber + "," + string);
            }
