...
import hrst.sczd.utils.ViewUtil;
import hrst.sczd.R;
...
public class HorizontalProgressBarWithProgress extends ProgressBar {
    ...
    private void initData() {
        mTextSize = ViewUtil.sp2px(mContext,DEFAULT_TEXT_SIZE);
        mTextOffset = ViewUtil.dp2px(mContext,DEFAULT_TEXT_OFFSET);
        mReachHeight  = ViewUtil.dp2px(mContext,DEFAULT_REACH_HEIGHT);
        mUnreachHeight = ViewUtil.dp2px(mContext,DEFAULT_UNREACH_HEIGHT);
    }
